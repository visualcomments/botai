...
Соответствие критериям приёмки (docs/botai-v2-design.md §17.3):
* A19 — обновление при локальной правке: работа сохраняется, конфликт виден;
* A28 — управляемая копия навыка обновляется без расширения прав.
